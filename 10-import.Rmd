...
Non-character columns are factors. Asserting for explicit values below as new or changed values may indicate different categorizations. This may affect prediction model accuracy.
...
```{r check_na}
for(col_name in names(dirty_df)) {
  dirty_df %>% 
